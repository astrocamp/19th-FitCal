...
${expression ? 'Expression: "' + expression + '"\n\n' : ""}`, el);
  ...
  function FlatpickrInstance(element, instanceConfig) {
    ...
    function bindEvents() {
      ...
      if (self2.daysContainer && !/iPhone|iPad|iPod/i.test(navigator.userAgent))
        bind3(self2.daysContainer, "mouseover", function(e2) {
      ...
      if (self2.timeContainer !== void 0 && self2.minuteElement !== void 0 && self2.hourElement !== void 0) {
        ...
        if (self2.amPM !== void 0) {
          bind3(self2.amPM, "click", function(e2) {
            updateTime(e2);
          });
        }
      }
    ...
    function buildMonth() {
      ...
      if (self2.config.showMonths > 1 || self2.config.monthSelectorType === "static") {
        ...
        bind3(self2.monthsDropdownContainer, "change", function(e2) {
    ...
    function setupMobile() {
      ...
      bind3(self2.mobileInput, "change", function(e2) {
  ...
  // src/scripts/flatpickr/styles.js
  var stylePresets = {
    healthy_style: {
      altInputClasses: [
        "px-2",
  ...
  // src/scripts/flatpickr/init.js
  var StyledFlatpickr = class {
  ...
  // src/scripts/flatpickr/main.js
  function initPickupTimePicker(seletor, style, options = {
    enableTime: true,
